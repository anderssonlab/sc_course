...
## [4.2.] Read out metainfo & UMAP data
```{r}
...
## [4.3.] Average mean cluster positions for cluster labels
```{r}
cls <- meta_comb %>%
...
## [4.4.] Map quality metrics onto UMAP
```{r}
coef = 0.5
cols <- base::c(
...
## [4.5.] Cluster-specific quality metrics
```{r}
ggplot2::ggplot(
      data = meta_comb,
      mapping = aes(
...
## [4.6.] Run analysis without removing mitoochondrial contaminations
#### No parameters changed comapred to [1.3.] - [3.4.]
